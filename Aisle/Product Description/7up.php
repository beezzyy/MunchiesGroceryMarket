    ...
    <div class="container-fluid">
        <div class="row">
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <form action="core/addToCart.php" method="GET">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="more-description">
                                        More Description <i class="fas fa-arrow-down"></i>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <p>
                                        Refresh yourself with a 7UP that is made entirely of natural ingredients and
                                        has the classic lemon lime flavour!
                                    </p>
                                </div>
                            </div>
                            ...
                            <h5>
                                <span class="third">$1.59/Bottle </span>
                                <br>
                                <span class="fourth">1 bottle (approx. 330mL)</span>
                            </h5>
                            ...
                            <button type="submit" class="btn btn-dark btn1">
