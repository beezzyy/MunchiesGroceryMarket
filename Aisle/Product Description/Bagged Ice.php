            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://cdnimg.webstaurantstore.com/images/products/extra_large/202123/1114724.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>No ice? No problem. Buy Munchies Bagged Ice</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$0.99/Bag </span>
                            <br><span class="fourth">1 bag (approx. 5Kg)</span>
                        </h5>
