            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.thespruceeats.com/thmb/3IAKAM_nPxKNRJfrdNsVdktNeH4=/960x0/filters:no_upscale():max_bytes(150000):strip_icc()/calamari_1806999-2-e8a531d5915e49719d5b049fd6fa00a1.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Calamari</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Tricky to cook and season. Ask our Seafood experts for some tips at the counter.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$10.60/lb </span>
                            <br><span class="fourth">1 Calamari (approx. 5lb)</span>
                        </h5>
