                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="../../Aisle/Frozen">Frozen</a>
                            <a class="dropdown-item" href="../Butchery.php">Butchery</a>
                            <a class="dropdown-item" href="../../Aisle/Seafood">Seafood</a>
            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://assets.bonappetit.com/photos/5a833c4b668fb87d44d15fc3/16:9/w_1280,c_limit/museum-of-candy-opening-in-nyc.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Candy</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Chocolate not you thing? Here at munchies we have snack for every sweet tooth.Make your own candy bag!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$11.99/Bag </span>
                            <br><span class="fourth">1 Varied Bag (approx. 1lb)</span>
                        </h5>
