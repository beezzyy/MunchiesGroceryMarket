            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/f/ff/Caviar_spoons.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Caviar</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>100 percent authentic Caviar. Hravested from the best quality Sturgeon available</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$75.99/jar </span>
                            <br><span class="fourth">1 Jar Caviar (approx. 30g)</span>
                        </h5>
