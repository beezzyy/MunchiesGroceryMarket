            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://i5.walmartimages.com/asr/c99dd5fe-34ba-4a25-b6e2-8f4f42df996b_3.98384eae2bacba1ca2d052153be52d27.png" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Chicken Nuggets</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Everyone's favorite; Chicken Nuggets!!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$7.95/Bag </span>
                            <br><span class="fourth">1 Bag (approx. 2lb)</span>
                        </h5>
