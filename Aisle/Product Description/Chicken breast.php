...
<body onload="onLoad()">
    ...
    <div class="container-fluid nav">
        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
            ...
            <div>
                ...
                ?>
                <a class="cartIcon" href="../../Shopping%20Cart.php"><img src="../../cartfinal-removebg-preview.png" alt="Cart" style="width: 40px; height:40px;">href="../../Shopping%20Cart.php"><img src="../../cartfinal-removebg-preview.png" alt="Cart" style="width: 40px; height:40px;"></a>
            </div>
        </nav>
    </div>
    ...
    <div class="div1">
        <a class="none" href="../Butchery.php">
            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://post.healthline.com/wp-content/uploads/2020/09/2375-Raw_Chicken-1296x728-header-1200x628.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Chicken breast</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Quick and easy to prepare, Maple Leaf Chicken Breast are great for weeknight dinners. Full of succulence and flavour!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$3.96/unit </span>
                            <br><span class="fourth">1 breast (approx. 200 g)</span>
                        </h5>
