            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.tasteofhome.com/wp-content/uploads/2017/11/shutterstock_389576623-1.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Cookies</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Have an old school, soft baked cookie, comes in chocolate chip, caramel pecan and double chocolate. Baked right here!</p>
                            </div>
                        </div>
                        ...
                        <h5><span class="third">$4.99/Bag </span>
                            <br><span class="fourth">1 Box (approx. 1.5lb)</span>
                        </h5>
