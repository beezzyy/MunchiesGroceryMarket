            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.marchespublics-mtl.com/wp-content/uploads/MPM_Poissons_Crabe.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Fresh Crab</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>All our Crab is freshly fished, ocean-to-table. Highest quality crab for the lowest available prices!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$30/lb </span>
                            <br><span class="fourth">1 Crab (approx. 2lb)</span>
                        </h5>
