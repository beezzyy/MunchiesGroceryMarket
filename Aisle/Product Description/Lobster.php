            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.washingtonpost.com/rf/image_982w/2010-2019/WashingtonPost/2020/08/13/Food/Images/v-howto-lobster_029.JPG" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Lobster</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Our lobster is of the best quality. No parasites, no worries! Try Munchies Lobster today!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$29.99/lb </span>
                            <br><span class="fourth">1 Lobster (approx. 1lb)</span>
                        </h5>
