            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.chickadvisor.com/item/40271/375/i/pogos.jpg?ic=1" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Pogo</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Bored of our other frozen foods? Try the classic Pogo for dinner or just a snack.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$8.99/Box </span>
                            <br><span class="fourth">1 box (approx. 1.5 Kg)</span>
                        </h5>
