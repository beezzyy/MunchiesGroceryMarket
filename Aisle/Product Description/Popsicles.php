            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.squarespace-cdn.com/content/5175ca67e4b06533f73d4a14/1368218112096-NS7EA3TL0ES5GRKH8G18/popsicle+box.jpg?format=1000w&content-type=image%2Fjpeg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Popsicles</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>NO Sugar! Comes in three amazingly fun flavors.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$3.99/Box </span>
                            <br><span class="fourth">1 box (approx. 1 Kg)</span>
                        </h5>
