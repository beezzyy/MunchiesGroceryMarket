            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.bowrivermeatmarket.ca/wp-content/uploads/2019/06/porkchops.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Pork chops</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Fire up the grill this season and enjoy these succulent pork loin chops.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$9.69/pack</span>
                            <br><span class="fourth">6 pork chops (approx. 800g)</span>
                        </h5>

                        <br>
                        Quantity:
                        <div class="box">
                            <input type="number" inputmode="numeric" value="1" min="1">
                        </div>
                        <br>
