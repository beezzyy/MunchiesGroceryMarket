            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://2.bp.blogspot.com/-83qPJ9IX-r0/UBhLAXS5XoI/AAAAAAAAAd8/3hFeyaPk-uw/s1600/100_9879.jpgg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Pretzels</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Enjoy the classic salty crunch of pretzels anytime here at Munchies.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$3.99/Bag </span>
                            <br><span class="fourth">1 Bag (approx. 1lb)</span>
                        </h5>
