            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://post.healthline.com/wp-content/uploads/2020/08/are-rice-cakes-healthy-1200x628-facebook-1200x628.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Rice Cakes</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Theres always a healthy alternative to any snack. Stay healthy and grab some rice cakes instead!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$4.99/Bag </span>
                            <br><span class="fourth">1 Bag (approx. 300g)</span>
                        </h5>
