            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.sweetandsavorybyshinee.com/wp-content/uploads/2021/05/Shrimp-2-1.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Shrimp</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Munchies shrimp, freshly caught every day! Great for stur frying or on their own.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$25.99/lb </span>
                            <br><span class="fourth">10 Shrimp (approx. 1lb)</span>
                        </h5>
                        ...
                        <br>
                        <button type="button" class="btn btn-dark btn1" 1 <i class="fas fa-shopping-cart fas"></i> Add1to Shopping Cart
                        </button>
