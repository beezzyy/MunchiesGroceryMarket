            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://theheritagecook.com/wp-content/uploads/2012/01/Raw-Ahi-Tuna-Steaks2-iStock.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Tuna Steak</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Munchies 100 percent pure, Ahi grade tuna steak.Enjoy cooked or raw anytime for a quick clean source of protein.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$30.00/lb </span>
                            <br><span class="fourth">1 Tuna Steak (approx. 4lb)</span>
                        </h5>
