            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.skinnytaste.com/wp-content/uploads/2018/12/Baked-Salmon-1.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Wild Salmon</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Fished by our very own Munchies employees, enjoy our fresh atlantic salmon, pan seared, baked or fried!!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$12.00/lb </span>
                            <br><span class="fourth">1 Wild Salmon (approx. 4lb)</span>
                        </h5>
