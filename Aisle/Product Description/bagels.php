            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.unsplash.com/photo-1585445490387-f47934b73b54?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Bagels</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>A chewy dense bread, shaped into circles, first boiled, then baked. Often topped before baking with seeds or minced roots such as garlic or onion, and typically served with butter or a soft cheese. Some people also make sandwiches out of them. Breakfast bagel sandwiches are particularly popular, with bacon, egg, and cheese.</p>
                            </div>
                        </div>
                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$1.55/unit </span>
                            <br><span class="fourth">(1 Bagel)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
