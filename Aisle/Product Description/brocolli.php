...
<head>
    ...
    <title>Brocolli - Description</title>
            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://post.healthline.com/wp-content/uploads/2020/09/benefits-of-broccoli-1200x628-facebook-1200x628.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Brocolli</h4>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Frozen baby brocolli freshly grown in the province of Quebec. Product is GMO free!</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$5.67/Pack </span>
                            <br><span class="fourth">around 148 grams/unit</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
