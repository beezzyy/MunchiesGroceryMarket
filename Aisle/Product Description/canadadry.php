            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://preview.free3d.com/img/2020/01/2279683203843229623/civw902w-900.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Canada Dry</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>The smooth, refreshing taste of Canada Dry Ginger Ale is as crisp as a morning spent on the lake. It's a classic for a reason: it's made with 100 percent natural flavors, including real ginger flavor.</p>
                            </div>
                        </div>
