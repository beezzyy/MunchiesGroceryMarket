...
<head>
    ...
    <title>Carrots - Description</title>
...
<body onload="onLoad()">
    ...
    <div class="div1">
        <a class="none" href="../FruitsAndVegetables.php">
            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.unsplash.com/photo-1447175008436-054170c2e979?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1599&q=80" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Carrots</h4>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Adult carrots about 9 inches long freshly grown in the province of Quebec. Product is GMO free! Comes in a pack of 5.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$3.45/Pack </span>
                            <br><span class="fourth">5 Carrots (Around 75 grams/unit)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
