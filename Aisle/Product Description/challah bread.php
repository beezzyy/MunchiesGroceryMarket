            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.unsplash.com/photo-1609970957077-6baa39b4a749?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Challah Bread</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Challah is a loaf of braided bread. The simple dough is made with eggs, water, flour, yeast and salt. The bread is typically pale yellow in color because so many eggs are used, and it has a rich flavor, too.</p>
                            </div>
                        </div>
                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$3.50/unit </span>
                            <br><span class="fourth">(1 Loaf of Challah Bread)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
