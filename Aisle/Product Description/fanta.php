            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://st.depositphotos.com/2121815/4264/i/600/depositphotos_42646321-stock-photo-can-of-fanta-drink-on.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Fanta drink is a wonderful fruit-flavored soda that goes well with a variety of snacks. Each Fanta drink is caffeine-free and made entirely of natural flavours.</p>
                            </div>
                        </div>
                        ...
                        <br>
                        <h5><span class="third">$1.49/Bottle </span>
