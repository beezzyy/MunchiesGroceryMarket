            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.packagingstrategies.com/ext/resources/Issues/June/July2012/Laura_uploads/Tropicana540.jpg?1559144132" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Orange Juice</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Give your body a full day's supply of Vitamin C and all the potassium found in a medium-sized banana by starting your day with a 250mL glass of 100% pure orange juice with no pulp. Each 250mL glass also contains a considerable amount of folate, which is important for healthy health.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$2.89/Bottle </span>
                            <br><span class="fourth">1 bottle (approx. 750mL)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
