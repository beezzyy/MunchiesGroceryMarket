            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.unsplash.com/photo-1583057341912-a0df64b8da4d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Pita Bread</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Pita Bread: This moist, light and flat bread could be made of both refined as well as whole wheat flour. Apart from being low in calories, it is also a rich source of protein and carbohydrate and contains adequate amount of vitamin B, selenium and manganese that work together as antioxidants.</p>
                            </div>
                        </div>
                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$0.89/unit </span>
                            <br><span class="fourth">(1 Slice of Pita Bread)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
