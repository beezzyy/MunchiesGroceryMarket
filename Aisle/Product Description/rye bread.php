            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.unsplash.com/photo-1509440159596-0249088772ff?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1472&q=80.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Rye Bread</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Rye bread is simply bread that is made with rye flour. Rye has an earthy flavor, and using more or less of it in combination with other flours a loaf will give it more or less of that flavor.</p>
                            </div>
                        </div>
                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$4.55/unit </span>
                            <br><span class="fourth">(1 Loaf of Rye Bread)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
