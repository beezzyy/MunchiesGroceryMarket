            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://cdn.pixabay.com/photo/2018/04/29/07/57/meat-3359248_1280.jpg" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Sirloin steak</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>The top sirloin is a naturally lean, thick cut of steak with a bold, beefy flavor. These thick steaks are best for grilling or pan searing. Made with 100% Canadian AAA Angus beef. Tender and juicy.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$8.53/unit </span>
                            <br><span class="fourth">1 steak (approx. 300 g)</span>
                        </h5>

                        <br>
                        Quantity:
                        <div class="box">
                            <input type="number" class="qtyBox" value="1" min="1">
                        </div>
                        <br>
