            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://images.unsplash.com/photo-1585478259715-876a6a81fc08?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Sourdough Bread</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>Sourdough bread is a great alternative to conventional bread. Its lower phytate levels make it more nutritious and easier to digest. Sourdough bread also seems less likely to spike your blood sugar levels, which makes it an option for those monitoring their blood sugar.</p>
                            </div>
                        </div>
                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$6.96/unit </span>
                            <br><span class="fourth">(1 Loaf of Sourdough Bread)</span>
                        </h5>
                        <br>
                        <br>
                        Quantity:
