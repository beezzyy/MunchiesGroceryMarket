            ...
            <div class="container" style="margin-top:30px">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <img src="https://www.factsaboutbpa.org/wp-content/uploads/2017/09/waterbottles.png" alt="" class="img1" style="width: 100%;">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <h4 class="product-name">Munchies Water</h4>
                        <br>
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <p>All our water bottles Munchies Water are made from 25% recycled plastic which saves the use of perishable resources and helps preserve the environment. So when you drink from a bottle of heavenly water remember that you enjoy nature and also preserve it.</p>
                            </div>
                        </div>

                        <p class="under-product-name"></p>
                        <br>
                        <h5><span class="third">$2.49/Bottle </span>
                            <br><span class="fourth">1 bottle (approx. 500mL)</span>
                        </h5>
